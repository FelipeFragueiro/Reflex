...
public class DetalleSerieFragment extends Fragment implements AdaptadorDeSeries.EscuchadorDeSerie,AdaptadorDeActoresRecycler.EscuchadorDeActores, View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView unTextViewDelGenero = (TextView) fragmentView.findViewById(R.id.textViewDelGeneroDeLaPelicula);
        TextView unTextViewDeLaDescripcion = (TextView) fragmentView.findViewById(R.id.textViewDeLaDescripcionDeLaSerieDetalle);
        cargarMovieTrailer(idDeSerie);
    ...
    public void cargarMovieTrailer(final String id) {
        ...
        final ResultListener<List<Trailer>> listResultListener = new ResultListener<List<Trailer>>() {
            ...
            public void finish(List<Trailer> resultado) {
                ...
                if(trailer.getId().equals("59c54ae4c3a368143002f65c")) {
                    fragment.setKeyto("oYnvxL9wYgo");
                }else {
                    fragment.setKeyto(trailer.getKey());
                }
                FragmentManager manager = getFragmentManager();
                manager.beginTransaction().replace(R.id.youtubeTrailerSerieMovie, fragment).addToBackStack(null).commit();
